...
go
alter function fnGetFullName()
--alter function fnGetFullName(@id int)
returns varchar(200)
as
begin
	declare @fullName varchar(200)
	select @fullName  = (cast(Id as varchar(5)) + '. ' + FirstName + ' ' + LastName) 
	from InternStudent
	--where id=@id
...
--select Id, FirstName, LastName, dbo.fnGetFullName(Id)as fullname from InternStudent
